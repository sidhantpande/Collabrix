package com.collabrix.notificationservice.mail;
...
class MailServiceTest {
    ...
    @BeforeEach
    void setUp() {
        mailService = new MailService(javaMailSender, templateEngine, notificationService, "noreply@collabrix.test", 3);
    }
    ...
    void sendConfirmationEmail_validNotification_sendsMessageAndMarksAsSent() {
        ...
        mailService.sendConfirmationEmail(notification, "http://collabrix.test/confirm?token=123");
