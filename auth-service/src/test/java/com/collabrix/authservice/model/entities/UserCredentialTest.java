package com.collabrix.authservice.model.entities;
...
class UserCredentialTest {
    ...
    void createUserCredentialShouldAssignRoleUserByDefault() {
        // Given / When
        UserCredential user = UserCredential.createUserCredential("john", "john@sidhantpande.in", "encoded-password");

        // Then
        assertThat(user.getRole()).isEqualTo(Role.ROLE_USER);
        assertThat(user.getUsername()).isEqualTo("john");
        assertThat(user.getEmail()).isEqualTo("john@sidhantpande.in");
