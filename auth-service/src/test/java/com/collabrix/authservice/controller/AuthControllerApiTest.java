...
class AuthControllerApiTest extends AbstractPostgresIntegrationTest {
    ...
    void postSignupShouldRegisterUserSuccessfully() throws Exception {
        // Given
        String requestBody = objectMapper.writeValueAsString(registerRequest("john", "john@sidhantpande.in", "Password123!"));
        ...
        mockMvc.perform(post("/api/auth/signup")
                ...
                .andExpect(jsonPath("$.email").value("john@sidhantpande.in"))
    ...
    void postLoginShouldReturnExpectedJsonStructure() throws Exception {
        ...
        String requestBody = objectMapper.writeValueAsString(loginRequest("john@sidhantpande.in", "Password123!"));
        ...
        mockMvc.perform(post("/api/auth/login")
                ...
                .andExpect(jsonPath("$.user.email").value("john@sidhantpande.in"))
    ...
    void postSignupShouldReturnConflictForDuplicateUsername() throws Exception {
        ...
        mockMvc.perform(post("/api/auth/signup")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(registerRequest("john", "john@sidhantpande.in", "Password123!"))))
                .andExpect(status().isOk());

        // When / Then
        mockMvc.perform(post("/api/auth/signup")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(registerRequest("john", "other@sidhantpande.in", "Password123!"))))
    ...
    void postSignupShouldReturnConflictForDuplicateEmail() throws Exception {
        ...
        mockMvc.perform(post("/api/auth/signup")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(registerRequest("other", "john@sidhantpande.in", "Password123!"))))
                .andExpect(status().isConflict())
    ...
    void postLoginShouldReturnUnauthorizedForBadCredentials() throws Exception {
        ...
        mockMvc.perform(post("/api/auth/login")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(loginRequest("john@sidhantpande.in", "wrong-password"))))
