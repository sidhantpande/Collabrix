package com.collabrix.taskservice.testsupport;
...
import com.collabrix.taskservice.model.dto.request.ReorderListsRequest;
import com.collabrix.taskservice.model.dto.request.UpdateBoardRequest;
import com.collabrix.taskservice.model.dto.request.UpdateTaskListRequest;
...
public final class TaskServiceTestFixtures {
    ...
    public static UserServiceClient.UserProfileResponse profile(UUID authId, String displayName) {
        return new UserServiceClient.UserProfileResponse(authId, displayName, "https://cdn.collabrix.test/" + displayName + ".png");
    }
}
