package com.collabrix.taskservice.integration;

import com.collabrix.taskservice.client.UserServiceClient;
import com.collabrix.taskservice.client.WorkspaceClient;
import com.collabrix.taskservice.events.TaskEventPublisher;
import com.collabrix.taskservice.model.dto.request.CreateBoardRequest;
import com.collabrix.taskservice.model.dto.request.CreateTaskListRequest;
import com.collabrix.taskservice.model.dto.request.CreateTaskRequest;
import com.collabrix.taskservice.model.dto.request.UpdateTaskRequest;
import com.collabrix.taskservice.model.dto.response.BoardResponseDTO;
import com.collabrix.taskservice.model.dto.response.TaskListResponseDTO;
import com.collabrix.taskservice.model.dto.response.TaskResponseDTO;
import com.collabrix.taskservice.model.enums.TaskStatus;
import com.collabrix.taskservice.repository.BoardRepository;
import com.collabrix.taskservice.repository.TaskListRepository;
import com.collabrix.taskservice.repository.TaskRepository;
import com.collabrix.taskservice.service.BoardService;
import com.collabrix.taskservice.service.TaskListService;
import com.collabrix.taskservice.service.TaskService;
import com.collabrix.taskservice.testsupport.AbstractPostgresTaskServiceTest;
