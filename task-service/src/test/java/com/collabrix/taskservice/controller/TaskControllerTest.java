package com.collabrix.taskservice.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.collabrix.taskservice.config.SecurityConfiguration;
...
import com.collabrix.taskservice.security.JwtAuthenticationFilter;
...
class TaskControllerTest {
    ...
    private TaskResponseDTO taskResponse(UUID taskId, UUID listId, UUID workspaceId, UUID assigneeAuthId) {
        return TaskResponseDTO.builder()
                ...
                .status(com.collabrix.taskservice.model.enums.TaskStatus.TODO)
                .build();
    }
