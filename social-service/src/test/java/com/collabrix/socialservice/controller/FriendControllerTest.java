package com.collabrix.socialservice.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.collabrix.socialservice.config.SecurityConfig;
import com.collabrix.socialservice.exception.GlobalExceptionHandler;
...
import com.collabrix.socialservice.security.JwtAuthenticationFilter;
import com.collabrix.socialservice.service.FriendshipService;
...
import static com.collabrix.socialservice.testsupport.JwtTestHelper.authentication;
...
class FriendControllerTest {
    ...
    void listFriends_authenticatedRequest_returnsFriendArray() throws Exception {
        when(friendshipService.listFriends(any())).thenReturn(List.of(
                FriendResponse.of(UUID.randomUUID(), "mary_dev", "http://cdn.sidhantpande.in/mary.png", Instant.now())
        ));
        ...
        mockMvc.perform(get("/social/api/friends")
                ...
                .andExpect(jsonPath("$[0].avatarUrl").value("http://cdn.sidhantpande.in/mary.png"));
    }
