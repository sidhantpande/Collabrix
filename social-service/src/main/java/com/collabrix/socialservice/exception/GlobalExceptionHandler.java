package com.collabrix.socialservice.exception;
...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleSocialServiceException(SocialServiceException exception) {
        ...
        problem.setType(URI.create("https://api.collabrix.com/errors/social-service/" + exception.getErrorType().name().toLowerCase()));
    ...
    public ProblemDetail handleValidation(MethodArgumentNotValidException exception) {
        ...
        problem.setType(URI.create("https://api.collabrix.com/errors/validation"));
    ...
    public ProblemDetail handleJwtExceptions(Exception exception) {
        ...
        problem.setType(URI.create("https://api.collabrix.com/errors/authentication"));
    ...
    public ProblemDetail handleNotFound(NoResourceFoundException exception) {
        ...
        problem.setType(URI.create("https://api.collabrix.com/errors/not-found"));
    ...
    public ProblemDetail handleGeneral(Exception exception) {
        log.error("Unhandled social service exception", exception);
        ProblemDetail problem = ProblemDetail.forStatusAndDetail(HttpStatus.INTERNAL_SERVER_ERROR, "Internal Server Error");
        problem.setTitle("Internal Server Error");
        problem.setType(URI.create("https://api.collabrix.com/errors/internal-server-error"));
