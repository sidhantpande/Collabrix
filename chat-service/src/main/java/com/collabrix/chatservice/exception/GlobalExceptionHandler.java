package com.collabrix.chatservice.exception;

import com.collabrix.chatservice.model.dto.response.ErrorResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleAccessDenied(AccessDeniedException exception) {
        ...
        problem.setType(URI.create("https://api.collabrix.com/errors/access-denied"));
